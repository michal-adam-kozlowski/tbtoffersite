    ...
    return (
      <div className="cruiseNameComponent">
        ...
        <div className="cruiseDateBox">
          <i className="far fa-calendar-alt"></i><h3 className="cruiseDate">{this.props.cruise.cruiseDate}</h3>
        </div>
        <div className="cruiseTypeBox">
          <i className="far fa-compass"></i><h3 className="cruiseType">{this.props.cruise.cruiseType}</h3>
        </div>
